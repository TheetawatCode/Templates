...
export default function FeaturesSectionDemo_03() {
  const features = [
    {
    ...
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div className="w-full  p-5  mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          {/* TODO */}
          <img
            src="https://images.unsplash.com/photo-1629904853716-f0bc54eea481?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="header"
            width={800}
            height={800}
...
export const Globe = ({ className }: { className?: string }) => {
  ...
  return (
    <canvas
      ref={canvasRef}
      className={cn("w-[600px] h-[600px] max-w-full aspect-square", className)}
    />
  );
};
